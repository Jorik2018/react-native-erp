...
class EmployeeList extends Component {
  ...
  updateEmployee = (data:any) => {
    ...
    this.setState({ employee: this.state.employee.map((emp:any) => emp.id == data.id ? data : emp) });
  }

  deleteEmployee = (employeeId:any) => {
    // delete employee lsit with deleted data if employee id is matched with updated data id
    this.setState({ employee: this.state.employee.filter((emp:any) => emp.id !== employeeId) })
  }

  render() {
    const { loading, errorMessage, employee, isAddEmployeeModalOpen,
      isEditEmployeeModalOpen, isDeleteEmployeeModalOpen, selectedEmployee }:any = this.state as any ;
    return (
      <ScrollView>
        ...
        <View style={styles.container}>
          ...
          {employee.map((data:any, index:number) => <View
          ...
          {isEditEmployeeModalOpen ? <EditEmployeeModal
            isOpen={isEditEmployeeModalOpen as boolean}
