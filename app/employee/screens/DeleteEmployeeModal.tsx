...
let props=this.props as any;
        ...
        fetch(`http://dummy.restapiexample.com/api/v1/delete/${props.selectedEmployee.id}`, {
            method: "DELETE"
        })
            .then(res => res.json())
            .then(res => {
    ...
    render() {
        const { isOpen, closeModal, selectedEmployee } = this.props as any;
        const { loading, errorMessage } = this.state as any;
        return (
            <Modal
                visible={isOpen}
